...
def arguments():
    ...
    parse.add_argument('--capacity', type=int, default=buffersize, help='buffer capacity')
...
name_model = prefix+'-buffersize='+str(buffersize)+'.pth'
name_plot = 'plots/' + algo +'-buffersize='+str(buffersize)+ '.png'
