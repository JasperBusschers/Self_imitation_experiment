...
def arguments():
    ...
    parse.add_argument('--weight_disc', type=float, default=0.5, help='buffer capacity')
    ...
    parse.add_argument('--capacity', type=int, default=8, help='buffer capacity')
